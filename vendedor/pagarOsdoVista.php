...
$result = $utilModelo2->consultarVariasTablas("tipo,codigo","usuario","codigo IN (SELECT codigoReferido FROM usuario WHERE codigo ='usuario32')");
       ?>
            ...
            <div class="widget">
                ...
                <form action="vendedorControlador.php" method="post">
                <!-- /widget-header -->
                        ...
                        <select class="selectpicker" onchange="persona()" name="lider" id="lider" data-show-subtext="true"
                            ...
                            <?php
                                ...
                                while ($fila = mysqli_fetch_array($result)) {
                                    if ($fila != NULL) {
                                        echo '<option value="' . $fila[1] . '" data-subtext="' . $fila[0] . '">' . $fila[1] . '</option>';
                                    }
                                }
                            ?>
                        </select>
